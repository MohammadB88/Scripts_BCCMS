...
def peak_position(a):
    peaks, properties = find_peaks(a, height=0.03)
    return peaks
...
axes_0.legend(labels=('0.0%','+2.0%','-2.0%'),loc='upper center', bbox_to_anchor=(0.5, 1.10), ncol=3, fancybox=True, shadow=True, fontsize = 19)
